...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-6 d-flex flex-column align-items-end">
            <a href="index.php?c=categorias&f=nuevo"> 
            ...
            <tbody class="tabladatos">
                ...
                foreach ($resultados as $fila) {
                    ...
                    <tr>
                        ...
                        <td><a class="btn btn-primary" href="index.php?c=categorias&f=editar&id=<?php echo $fila['Id_categoria']; ?>"><i class="fas fa-marker"></i></a>
                            <a class="btn btn-danger" onclick="if (!confirm('Esta seguro de eliminar el producto?'))
                                        return false;"  href="index.php?c=categorias&f=eliminar&id=<?php echo $fila['Id_categoria']; ?>">
